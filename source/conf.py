...
project = u'Django+Vue.js 实战派,Python Web开发与运维'
...
htmlhelp_basename = 'Django+Vue.js实战派,Python Web开发与运维'
html_logo = '_templates/my_python_web.png'
...
html_title = u'Django+Vue.js实战派,Python Web开发与运维'
...
latex_documents = [
    (master_doc, 'Django+Vue.js实战派,Python Web开发与运维.tex', u'Django+Vue.js实战派,Python Web开发与运维 Documentation',
